...
import sys
sys.path.insert(0, "/home/ma/git/bitwuzla/build-docs/src/api/python")

# Add path to enable custom extensions
sys.path.insert(0, '/home/ma/git/bitwuzla/docs/extensions/')

# -- Project information -----------------------------------------------------

project = 'Bitwuzla'
copyright = '2023, the authors of Bitwuzla'
...
html_static_path = ['/home/ma/git/bitwuzla/docs/_static']
...
lig_source_dir = '/home/ma/git/bitwuzla/docs'
lig_build_dir = '/home/ma/git/bitwuzla/build-docs/docs'
